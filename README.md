...
2) You are never required to swap disks at any point during gameplay, as opposed to the GameCube and DreamCast versions. Since all of the game is contained within a single DVD, this removes the need to decompile extra and duplicated code.  
