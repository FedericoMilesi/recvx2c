...
void RegistAdxStreamEx(int MaxStream, int DummyStream, SOUND_ADX* pAdx)
{
    SOUND_TALK_INFO* tp;
    int i;
...
void WakeupAdxStream(SOUND_ADX* pAdx)
{
    SOUND_TALK_INFO* tp;
    int i;
