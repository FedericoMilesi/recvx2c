...
typedef Unknown8 type_74[4];
typedef Unknown8 type_75[4][0];


typedef short type_78[256];
typedef char type_79[3];
typedef int type_80[64];
typedef MODEL_DATA type_81[450];
...
typedef MODEL_DATA type_119[16];
...
void bhSetLighterFire(Unknown1* op, int flg);
