...
typedef _anon20 type_17[8];
typedef short type_18[32];
typedef _anon29 type_19[1];
...
typedef _anon42 type_92[4];
typedef _anon2 type_93[4];
typedef int type_94[450];
typedef unsigned int type_95[29];
typedef unsigned char type_96[41];
typedef unsigned int type_97[29][11];
typedef unsigned int type_98[8];
typedef unsigned char type_99[450];
typedef float type_100[128];
typedef char type_101[16];
typedef char* type_102[19];
typedef char type_103[4];
typedef _anon27 type_105[2];
typedef unsigned int type_106[32];
typedef unsigned char type_107[40];
typedef _anon20 type_108[9];
typedef unsigned char type_109[256];
typedef unsigned int type_110[16];
typedef _anon23 type_111[64];
typedef unsigned int type_112[16];
typedef _anon23 type_113[64];
typedef unsigned int type_114[32];
typedef _anon23 type_115[64];
typedef unsigned int type_116[16];
typedef unsigned int type_117[3];
typedef unsigned char type_118[141];
...
typedef unsigned char type_123[16];
typedef unsigned char type_124[16][2];
typedef unsigned int type_125[2];
typedef unsigned char type_126[2];
typedef _anon20 type_127[9];
typedef int* type_128[16];
typedef unsigned int type_129[4];
typedef unsigned char type_130[126];
typedef char type_131[32];
typedef npobj* type_132[16];
typedef char type_133[64];
typedef unsigned char* type_134[32];
typedef _anon1* type_135[16];
typedef char type_136[4];
typedef _anon14 type_137[16];
typedef short type_138[4];
typedef unsigned char type_139[4];
typedef _anon39 type_140[16];
typedef float type_141[3];
typedef float type_142[3][3];
...
struct _anon7
{
	...
	short wdx;
	short wdy;
	unsigned char word[16][2];
	unsigned char* mesp;
	unsigned char* scp;
	unsigned char* sclb[32];
	int mes_no;
	int mes_ln;
	int flash;
	float bar[3][3];
