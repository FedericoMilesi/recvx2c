...
typedef TEXTURE_BUFFER type_92[256];
...
typedef MODEL_DATA type_162[16];
...
Unknown1* bhEne22_SetDengekiEffect(BH_PWORK* epw, int obj, NJS_POINT3* ofs, float size);
...
Unknown1* bhEne22_SetElectricLightEffect(BH_PWORK* epw);
