...
typedef MODEL_DATA type_36[16];
typedef Unknown1* type_37[512];
typedef float type_38[4];
typedef char type_39[256];
typedef float type_40[4];
typedef Unknown18 type_41[21];
...
typedef TEXTURE_BUFFER type_80[256];
...
typedef MODEL_DATA type_88[450];
...
typedef Unknown1 type_120[0];
typedef BOUNDARY type_121[64];
...
typedef MODEL_DATA type_145[16];
...
typedef Unknown1* type_154[512];
typedef float type_156[5];
typedef Unknown1* type_157[128];
...
Unknown18 CapColTabA[23];
Unknown18 CapColTabB[21];
...
BOUNDARY* bhEne03_GetWall(BH_PWORK* epw);
BOUNDARY* bhEne03_Collision(BH_PWORK* epw);
BOUNDARY* bhEne03_Collision2(BH_PWORK* epw, BOUNDARY* gnd);
int bhEne03_CollisionWallBox(BOUNDARY* hp, NJS_POINT3* pos, float ar);
int bhEne03_CollisionWallGround(BOUNDARY* hp, NJS_POINT3* pos, float ar);
int bhEne03_CollisionWallCylinder(BOUNDARY* hp, NJS_POINT3* pos, float ar);
int bhEne03_CollisionWallSlope(BOUNDARY* hp, NJS_POINT3* pos, float ar);
int bhEne03_CollisionWallTriangle(BOUNDARY* hp, NJS_POINT3* pos, float ar);
int bhEne03_CollisionBoxEdge(BOUNDARY* hp, NJS_POINT3* pos, float ar);
