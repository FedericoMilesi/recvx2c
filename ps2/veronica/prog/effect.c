...
typedef MODEL_DATA type_80[450];
...
unsigned int bhGetGidx(Unknown1* op);
Unknown1* bhSetExtraEffectWork();
...
int bhSetEffectTb(Unknown8* efp, NJS_POINT3* off, unsigned char* lkp, int lkono);
