...
typedef _anon23 type_13[4];
typedef _anon0* type_14[512];
typedef _anon1* type_15[1300];
...
typedef _anon20 type_108[64];
typedef unsigned int type_109[32];
typedef _anon20 type_110[64];
...
typedef _anon1* type_126[16];
typedef char type_127[4];
typedef _anon12 type_128[16];
typedef short type_129[4];
typedef unsigned char type_130[4];
typedef _anon36 type_131[16];
...
_anon4* sys;
void(*bhDraw134)(_anon0*);
_anon0 eff[0];
_anon0* ef_Zanzo[6];
_anon41 cam;
void(*bhDraw136)(_anon0*);
void(*bhDraw137)(_anon0*);
_anon7* rom;
void(*bhDraw138)(_anon0*);
