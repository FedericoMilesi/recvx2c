...
typedef _anon43 type_137[16];
typedef npobj* type_138[16];
typedef _anon10* type_139[16];
typedef float type_140[4];
typedef _anon47 type_141[16];
typedef unsigned int type_142[2];
typedef float type_143[4];
typedef _anon42* type_144[32];
typedef int type_145[5];
typedef float type_146[4];
typedef _anon58* type_147[128];
typedef int type_148[6];
typedef _anon42* type_149[32];
typedef _anon44 type_150[20];
typedef _anon42* type_151[32];
...
struct _anon56
{
	...
	_anon42* ef_opq[512];
	_anon42* ef_thl[512];
	_anon42* ef_ntx2d[128];
	_anon42* ef_trs2d[128];
	_anon42* ef_pnc2d[128];
	_anon42* ef_fnc[512];
	int ob_nlgn;
	int ob_hlgn;
	int ob_spcn;
