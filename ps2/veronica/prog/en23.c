...
typedef TEXTURE_BUFFER type_89[256];
...
typedef MODEL_DATA type_160[16];
...
typedef Unknown1* type_173[512];
typedef Unknown1* type_174[128];
...
ENTITY ene24;
_anon32 BloodTbl[37];
Unknown18 CapColTabA[25];
Unknown18 CapColTabB[23];
_anon39 DmgReact[21];
