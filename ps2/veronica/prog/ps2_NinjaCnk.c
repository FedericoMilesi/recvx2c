...
int iNaCnkVerBufMax;
VU1_STRIP_BUF NaCnkStrBufTop[200];
...
VU1_COLOR NaCnkConstantMaterial;
float fNaCnkAlphaMaterial;
VU1_COLOR NaCnkDiffuseMaterial;
float fNaCnkMaterialSpeE;
VU1_COLOR NaCnkSpeculaMaterial;
VU1_COLOR NaCnkAmbientMaterial;
VU1_COLOR NaCnkAmbientFunctionEm;
VU1_COLOR NaCnkAmbientFunctionSm;
...
extern SCISSOR_PLANE_SET planeset;
extern SCISSOR_SYSTEM scissorflip;
extern SCISSOR_NODE node;
...
// void (*vu1DrawTriangleStripOpaqueSingle)(unsigned long, VU1_STRIP_BUF*, unsigned short, unsigned short);
// void (*vu1DrawTriangleStripTransSingle)(unsigned long, VU1_STRIP_BUF*, unsigned short, unsigned short);
// void (*vu1DrawTriangleStripTransDoubleI)(unsigned long, VU1_STRIP_BUF*, unsigned short, unsigned short);
// void (*vu1DrawTriangleStripTransDouble)(unsigned long, VU1_STRIP_BUF*, unsigned short, unsigned short);
