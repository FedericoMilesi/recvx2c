...
{
    _anon3* pHdrPs; // address of the header of the position data
    _anon2* pHdrCv; // address of the header of the morphing data
    int i; // index of the morphing data
    NJP_QUATERNION pd4; // destination quaternion
    NJP_QUATERNION* ps4; // source quaternion
    NJS_POINT3 pd3; // destination vector
    NJS_POINT3* ps3; // source vector
