...
typedef MODEL_DATA type_112[16];
...
typedef Unknown1* type_122[128];
typedef Unknown1* type_123[512];
typedef unsigned char type_124[64];
typedef Unknown1* type_125[512];
...
BOUNDARY* bhCheckWallType(NJS_POINT3* pos, unsigned int flg, float ar, float ah);
BOUNDARY* bhCheckWallType2(NJS_POINT3* pos, unsigned int flg, float aw, float ad, float ah, int idx_ct);
BOUNDARY* bhCheckWallRefAngle(NJS_POINT3* pos, unsigned int flg, float ar, float ah, int* ay);
void bhSetWallRefAngle(BOUNDARY* hp, NJS_POINT3* pos, float ar, float ah, int* ay);
float bhGetGroundPosition(NJS_POINT3* pos);
int bhCheckInnerTriangle(BOUNDARY* hp, NJS_POINT3* pos, float ar, float ah);
int bhCheckInnerTriangle2(BOUNDARY* hp, NJS_POINT3* pos, float aw, float ad, float ah);
int bhCheckInnerTriangle3(BOUNDARY* hp, NJS_POINT3* pos);
int bhCheckBox(BOUNDARY* hp, NJS_POINT3* pos, float ar, float ah, unsigned int aflg);
int bhCheckBox2Box(BOUNDARY* hp, NJS_POINT3* pos, float aw, float ad, float ah);
...
void bhSetUseKaidanFlag(BH_PWORK* pp, BOUNDARY* exp, int idx);
void bhClrUseKaidanFlag(BH_PWORK* pp);
void bhSetDansaLimitAtari(BH_PWORK* pp);
BOUNDARY* bhCheckDansaAtari(int flr_no, float px, float pz);
...
BOUNDARY* bhCheckFloorEnemy(int flr_no, float px, float pz);
BOUNDARY* bhCheckFloorEffect(int flr_no, float px, float pz);
BOUNDARY* bhCheckWater(NJS_POINT3* pos);
BOUNDARY* bhCheckL2Water(NJS_LINE* lp, NJS_POINT3* pos);
void bhResetAtariAttr();
void bhCheckPlayer(BH_PWORK* pp);
void bhCheckEnemies(BH_PWORK* pp);
int bhCheckWallAttrB89(BOUNDARY* hp);
