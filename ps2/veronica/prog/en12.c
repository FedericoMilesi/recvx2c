...
typedef NJS_POINT3 type_64[150];
typedef _anon7 type_65[256];
typedef _anon15 type_66[450];
typedef char type_67[3];
typedef _anon23 type_68[16];
...
typedef NJS_POINT3 type_128[32];
