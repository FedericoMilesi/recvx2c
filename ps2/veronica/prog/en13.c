...
typedef MODEL_DATA type_121[16];
...
typedef Unknown1* type_133[128];
typedef Unknown1* type_134[512];
...
void bhEne13_ScaleModel(NJS_OBJECT* pObj, float sx, float sy, float sz);
