...
typedef void(*type_51)(void*, int);
typedef void(*type_110)(void*);
typedef void(*type_132)(void*, int);

typedef unsigned char type_0[2];
typedef unsigned int type_1[1040];
...
typedef _anon37 type_116[18];
typedef unsigned int type_117[32];
typedef unsigned int type_118[16];
typedef BH_PWORK* type_119[16];
typedef unsigned int type_120[8];
typedef unsigned int type_121[1];
typedef unsigned int type_122[384];
typedef unsigned short type_123[10];
typedef unsigned int type_124[2];
typedef int* type_125[16];
typedef unsigned int type_126[4];
typedef npobj* type_127[16];
typedef _anon2* type_128[16];
typedef char type_129[4];
...
typedef _anon35 type_138[64];
typedef _anon0* type_139[512];
typedef _anon35 type_140[64];
typedef unsigned int type_141[32];
typedef _anon0* type_142[128];
typedef _anon35 type_143[64];
typedef NJS_POINT3 type_144[32];
typedef unsigned int type_145[3];
typedef _anon0* type_146[512];
typedef unsigned char type_147[64];
...
int mcNewCreateConfigFile(tagMEMORYCARDSTATE* pCard, tagCONFIGFILE* pConfigFile);
tagICONINFORMATION* mcCreateIconInit(tagICONINFORMATION* pIcon, char** cppFileName, unsigned int ulFileNamber);
...
tagSELECTFILEWINDOW* mcCreateFileSelectWindow(tagSELECTFILEWINDOW* pWin, tagSELECTFILEINFO* pFileInfo, unsigned int ulRecord);
void mcSetFileSelectWindowCursolInit(tagSELECTFILEWINDOW* pWin);
