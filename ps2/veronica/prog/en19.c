...
typedef MODEL_DATA type_48[16];
typedef Unknown1* type_49[512];
...
typedef TEXTURE_BUFFER type_85[256];
...
typedef MODEL_DATA type_95[450];
...
typedef BOUNDARY type_125[64];
typedef unsigned int type_126[32];
typedef BOUNDARY type_127[64];
...
_anon13* bhEne19_SetLeftClaw(MODEL_DATA* mlwP, _enum_6 tgt_bas, _enum_6 tgt_obj);
