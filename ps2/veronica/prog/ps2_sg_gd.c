...
typedef struct GDS_FS_DIRREC_ENT GDS_FS_DIRREC_ENT;
typedef struct GDS_FS_WORK GDS_FS_WORK;

typedef struct Ps2SgGdAnon1 Ps2SgGdAnon1;
...
Ps2SgGdAnon1 dvd_image_data[19];

// TODO: Decide if we want to use the following function prototypes
// or use the ones from the sg_gd.h file.
