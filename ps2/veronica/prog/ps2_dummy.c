...
extern unsigned int Ps2_highlight;
extern float Ps2_rand_seed[4];
...
extern unsigned int Ps2_ot_list_no;
extern void* Ps2_PP;
extern _anon17 Ps2_ot_list[8192];
extern unsigned int Ps2_now_bank;
extern _anon17* Ps2_OT[2][4096];
extern float Ps2AddPrimPrio;
extern unsigned char Ps2_PBUFF[1835008];
extern unsigned int Ps2_current_texbreak;
extern _anon16 Ps2_tp_tag[64];
extern _anon31 ps2_tp_cache[64];
extern unsigned int Ps2_tex_cache_num;
extern unsigned int Ps2_tex_cache_beflag[4];
extern void* Ps2_tex_cache_buff[4];
...
extern unsigned int Ps2_divide_flag;
...
extern NJS_MATRIX mbuf[128];
extern NJS_MATRIX lcmat[12]; // ORIGIN
extern NJS_MATRIX cmmat[2];
extern NJS_MATRIX crmat;
extern unsigned char* _BSG_END;
extern int _nj_tex_count;
...
void _builtin_set_imask(int mask) { } // Line 202, Address: 0x2cb060, Func Offset: 0
...
{ // Line 417, Address: 0x2cb5c0, Func Offset: 0
    pdGetPeripheral(0); // Line 424, Address: 0x2cb5c8, Func Offset: 0x8
    Ps2SwapDBuff(); // Line 554, Address: 0x2cb5d0, Func Offset: 0x10
...
{
    float max;
    /* Duped by the disassembler */ // float max;
    /* Duped by the disassembler */ // float max;
    float fz[4][3];
    int j;
    long128* p128;
