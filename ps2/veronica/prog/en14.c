...
typedef MODEL_DATA type_76[450];
...
typedef MODEL_DATA type_117[16];
...
typedef Unknown1 type_125[0];
typedef Unknown1* type_126[128];
typedef Unknown1* type_127[512];
